...
We rely exclusively on the data files provided in this repository (https://github.com/StoreyLab/human_differentiation_analysis).
...
Both kinship matrices have individual IDs stored in the row and colum names, which we use for sorting.
...
Fst_wc <- fst_wc( X, labs = fam$fam )$fst
Fst_hudson_k <- fst_hudson_k( X, labs = fam$fam )$fst
